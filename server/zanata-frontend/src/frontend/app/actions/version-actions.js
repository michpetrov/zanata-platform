 ...
 * @param {{ matchPercentage: number, differentProject: boolean, differentDocId: boolean, differentContext: boolean, fromImportedTM: boolean, fromAllProjects: boolean, selectedLanguage: {localeId: string, displayName: string}, selectedVersions: Array.<{projectSlug: string, version: {id: string}}> }} mergeOptions
