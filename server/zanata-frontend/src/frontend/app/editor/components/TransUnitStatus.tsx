...
type TransUnitStatusProps = {
    phrase: object;
};
type TransUnitStatusState = {};
/**
 * Status indicator showing the state of the translations
 * and some other metadata about a phrase.
 */
class TransUnitStatus extends React.Component<TransUnitStatusProps, TransUnitStatusState> {
    render() {
        ...
        <button tabIndex="-1" className="TransUnit-metaDataButton" title={phrase.comments + ' comments'}>
        ...
        <button tabIndex="-1" className="TransUnit-metaDataButton" title="1 Error">
